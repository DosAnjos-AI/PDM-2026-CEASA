-- Erro do modelo silver.modelo_regressao_linear quebrado por produto, na
...
-- da media via NULLIF). Serve para decidir se a Gold precisa filtrar mais
-- produtos -- nao decide isso aqui, so mede.
